...
# Adicionar tabela com contagem dos componentes de cada cluster no Dash
import dash
...
# Função para aplicar t-SNE e KMeans para visualizar clusters
...
# Função para gerar a tabela de contagem de clusters


def gerar_tabela_clusters(df_tsne):
    contagem = Counter(df_tsne['Cluster'])
    tabela = pd.DataFrame(contagem.items(), columns=['Cluster', 'Contagem'])
    return tabela
...
# Gerar a tabela de contagem de clusters
...
app.layout = html.Div([
    ...
    # Tabela de contagem dos clusters
    html.H2("Tabela de Contagem de Clusters", style={
    ...
    html.Div([
        dash_table.DataTable(
            ...
            style_table={'width': '40%', 'margin': '0 auto'},
